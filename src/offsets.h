...
const static ethMod_t ethMods[] = {
	...
	{ "jaymod",		"1.4",			0xbd9bb6ad,	MOD_JMOD },
	{ "noquarter",		"1.0.1",		0x279e6121,	MOD_NQ },
 	{ "noquarter",		"1.0.2",		0x279e6121,	MOD_NQ }, 
 	{ "noquarter",		"1.0.4",		0x73cc70ea,	MOD_NQ },
 	{ "noquarter",		"1.1.0",		0xc47ea2cb,	MOD_NQ },
  	{ "noquarter", 		"1.1.1",		0xf8ba3912, 	MOD_NQ },
	{ "noquarter",		"1.2.0",		0xca6dbc85,	MOD_NQ },
	{ "noquarter",		"1.2.3",		0x5e72a80,	MOD_NQ },
	{ "noquarter",		"1.2.5",		0x4fb8cc57, 	MOD_NQ },
	{ "nq",			"1.2.7",		0xd5ae14e9, 	MOD_NQ },
	{ "nq",			"1.2.9",		0x482aa9e4, 	MOD_NQ },
	{ "etnam",		"0.1.0",		0x2e8f52be, 	MOD_ETNAM },
	...
	{ "jaymod",	"2.0.1", 0xc2051741, MOD_JMOD,
	...
	{ "jaymod",	"2.0.2", 0x6528a7e0, MOD_JMOD,
		0x0,//0x34d70,		// CG_Missile()
		0x28d6180, 2704,	// cg_entities
		0xe93f20, 0x940c,0x1bc,   // cgs
		0x692f0,	// CG_Trace()
	...
	{ "jaymod",	"2.0.3", 0x15ba6692, MOD_JMOD,
		0x0,//0x34d70,	// CG_Missile()
		0x28d6180, 2704,	// cg_entities
		0xe93f20, 0x940c,0x1bc,   // cgs
		0x692f0,	// CG_Trace()
 	...
 	{ "jaymod", "2.0.4", 0xc1bad5b3, MOD_JMOD,
		0x0,//0x34d70,	// CG_Missile()
		0x28d6180, 2704,	// cg_entities
		0xe93f20, 0x940c,0x1bc,   // cgs
		0x692f0,    // CG_Trace()
	...
	{ "jaymod", "2.1.0 beta", 0x5f24fa23, MOD_JMOD,
	...
	{ "jaymod", "2.1.1 beta", 0x8352a951, MOD_JMOD,
		0x0,//0x769e0,	// CG_Missile()
		0x226860, 2708,			// cg_entities
		0x4cb860, 0x940c,0x1bc,	// cgs
		0xace20,	// CG_Trace()
	...
	{ "jaymod", "2.1.7", 0x3eac383d, MOD_JMOD,
		0x0,				// CG_Missile()
	...
	{ "jaymod", "jaymod 20080125-2.1.8", 0x2aca67dd, MOD_JMOD,
		0x0,				// CG_Missile()
