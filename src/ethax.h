...
#define ETH_CVAR_PREFIX "EThax_"
#define ETH_CMD_PREFIX "EThax_"

#define ETH_MENU_KEY XK_F5	// X11 key
#define ETH_PLAYERLIST_KEY XK_F6	// X11 key
#define ETH_POINTER_KEY XK_F7 // X11 key
#define ETH_CAM_DROPKEY XK_F8 // X11 key
#define ETH_CONFIG_FILE ".EThaxPrivConf"
...
void humanAimLogin(float pitch, float yaw); // Human Mode by Immortal
void humanAimFast(float pitch, float yaw); // Human Mode by Immortal
